...
// Solution      ::    MostDev
// Filename      ::    MostDev.Generics.Program.cs
// By            ::    Arjan Crielaard
...
namespace MostDev.Generics
{
    public class Program
    {
        ...
        {
            foreach (var i in Integers()) Console.WriteLine(i.ToString(), 5, "something");
        }
        ...
        public static void Main(string[] args)
        {
            ...
            var genList = new GenericList<SomeTupe>();
            genList.AddNode(new SomeTupe());
            genList.AddNode(new SomeTupe());
            genList.AddNode(new SomeTupe());
            genList.AddNode(new SomeTupe());

            foreach (var v in genList) Console.WriteLine(v);
