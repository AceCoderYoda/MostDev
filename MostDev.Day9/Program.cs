...
// Solution      ::    MostDev
// Filename      ::    MostDev.Day9.Program.cs
// By            ::    Arjan Crielaard
...
namespace MostDev.Day9
{
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            foreach (var i1 in list) Console.WriteLine(i1);

            var timer = new Timer(state => { Console.WriteLine("It triggered again!"); }, null, 1_000, 1_000);

            var timerOnce = new Timer(state => { Console.WriteLine("It triggered Just the once!"); }, null, 1_000, -1);
