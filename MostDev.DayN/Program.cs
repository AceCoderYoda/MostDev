...
// Solution      ::    MostDev
// Filename      ::    MostDev.DayN.Program.cs
// By            ::    Arjan Crielaard
...
namespace MostDev.DayN
{
    ...
    internal class Program
    {
        ...
        private static void a_MultipleOfFiveReached(string message)
        {
    ...
    public class Adder
    {
        ...
        {
            var iSum = x + y;
            if (iSum % 5 == 0 && OnMultipleOfFiveReached != null) OnMultipleOfFiveReached("Multiple of five");
            return iSum;
        }
    }
}