...
// Solution      ::    MostDev
// Filename      ::    MostDev.AdvWeb.ManageController.cs
// By            ::    Arjan Crielaard
...
using MostDev.AdvWeb.Models.ManageViewModels;
using MostDev.AdvWeb.Services;

#endregion

namespace MostDev.AdvWeb.Controllers
{
    [Authorize]
    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MostDev.AdvWeb"),
